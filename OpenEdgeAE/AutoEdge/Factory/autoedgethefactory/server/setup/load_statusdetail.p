...
if not can-find(StatusDetail where StatusDetail.Code eq 'CREDIT-APPROVED') then
do: 
    create statusdetail.
    assign 
        statusdetail.statusdetailid = guid(generate-uuid)
        statusdetail.code           = 'CREDIT-APPROVED'
        statusdetail.description    = 'Credit Approved'
        .
end.

if not can-find(StatusDetail where StatusDetail.Code eq 'CREDIT-REJECTED') then
do: 
    create statusdetail.
    assign 
        statusdetail.statusdetailid = guid(generate-uuid)
        statusdetail.code           = 'CREDIT-REJECTED'
        statusdetail.description    = 'Credit Rejected'
        .
end.
